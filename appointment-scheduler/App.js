...
export default function App() {
  ...
  <Stack.Navigator >
    ...
    <Stack.Screen options={{headerShown: true}} name="BookingScreen" component={BookingScreen} />
    <Stack.Screen options={{headerShown: true}} name="ConfirmationScreen" component={ConfirmationScreen} />
  </Stack.Navigator>
</NavigationContainer>);
}
